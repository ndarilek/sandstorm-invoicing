...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "780g3k96yhpejg7f92evd3n5px3xp59aptfxuj2520qzpp5pv9fh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Invoicing"),
    ...
    metadata = (
      ...
      # website = "https://github.com/ndarilek/alexandria",
      # This should be the app's main website url.

      codeUrl = "https://github.com/ndarilek/sandstorm-invoicing",
      ...
      shortDescription = (defaultText = "Invoicing system"),
  ...
  viewInfo = (
    ...
    # https://github.com/sandstorm-io/sandstorm/blob/master/src/sandstorm/grain.capnp
      (
        ...
        title = (defaultText = "create"),
        # Display name of the permission, e.g. to display in a checklist of permissions
        # that may be assigned when sharing.

        description = (defaultText = "can create new invoices"),
      ...
      (
        ...
        description = (defaultText = "can modify created invoices"),
      ),
    ],
